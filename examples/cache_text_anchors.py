...
PromptLearner (which owns TextRelationBlock as a submodule), builds every identity's per-branch
...
pre-relational-attention version of this pipeline did it: PromptLearner and TextRelationBlock are
...
against a fixed table, and makes it obvious in the codebase that PromptLearner/TextRelationBlock's
